...
local aa = {
    ...
    [47] = function()
        ...
        local af = {Names = {"Dark", "Darker", "Light", "Aqua", "Amethyst", "Rose", "Brown"}}
    ...
    [54] = function()
        return {
            Name = "Brown",
            Accent = Color3.fromRGB(139, 69, 49), 
            AcrylicMain = Color3.fromRGB(60, 40, 30),  
            AcrylicBorder = Color3.fromRGB(102, 51, 0),  
            AcrylicGradient = ColorSequence.new(Color3.fromRGB(166, 124, 88), Color3.fromRGB(120, 70, 40)),
            AcrylicNoise = 0.85,
            TitleBarLine = Color3.fromRGB(92, 64, 51), 
            Tab = Color3.fromRGB(130, 82, 45), 
            Element = Color3.fromRGB(160, 110, 75),  
            ElementBorder = Color3.fromRGB(102, 51, 0), 
            InElementBorder = Color3.fromRGB(70, 40, 30), 
            ElementTransparency = 0.85,
            ToggleSlider = Color3.fromRGB(139, 99, 59), 
            ToggleToggled = Color3.fromRGB(255, 255, 255),  
            SliderRail = Color3.fromRGB(139, 99, 59), 
            DropdownFrame = Color3.fromRGB(150, 100, 60),  
            DropdownHolder = Color3.fromRGB(80, 40, 30), 
            DropdownBorder = Color3.fromRGB(90, 60, 40), 
            DropdownOption = Color3.fromRGB(160, 90, 50), 
            Keybind = Color3.fromRGB(139, 99, 59),  
            Input = Color3.fromRGB(160, 100, 60),  
            InputFocused = Color3.fromRGB(100, 60, 30), 
            InputIndicator = Color3.fromRGB(170, 120, 80),
            Dialog = Color3.fromRGB(80, 40, 30),
            DialogHolder = Color3.fromRGB(60, 30, 20),
            DialogHolderLine = Color3.fromRGB(70, 35, 25),
            DialogButton = Color3.fromRGB(130, 80, 45),
            DialogButtonBorder = Color3.fromRGB(100, 60, 30), 
            DialogBorder = Color3.fromRGB(90, 50, 30),
            DialogInput = Color3.fromRGB(140, 65, 30), 
            DialogInputLine = Color3.fromRGB(150, 90, 45),
